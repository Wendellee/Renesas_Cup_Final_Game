...
static StaticTask_t display_thread_memory;
                ...
                static uint8_t display_thread_stack[0x1000] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #else
static uint8_t display_thread_stack[0x1000] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.display_thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
#endif
#endif
...
const rm_freertos_port_parameters_t display_thread_parameters = { .p_context =
		(void*) NULL, };
