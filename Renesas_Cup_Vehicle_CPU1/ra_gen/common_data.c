...
const icu_extended_cfg_t g_external_irq19_ext_cfg = { .filter_src =
		EXTERNAL_IRQ_DIGITAL_FILTER_PCLK_DIV, };

const external_irq_cfg_t g_external_irq19_cfg = { .channel = 19, .trigger =
		EXTERNAL_IRQ_TRIG_FALLING, .filter_enable = true, .clock_source_div =
		EXTERNAL_IRQ_CLOCK_SOURCE_DIV_64, .p_callback =
		nrf24_command_irq_callback,
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = (void*) &NULL,
#endif
		.p_extend = (void*) &g_external_irq19_ext_cfg, .ipl = (12),
...
const external_irq_instance_t g_external_irq19 = { .p_ctrl =
		&g_external_irq19_ctrl, .p_cfg = &g_external_irq19_cfg, .p_api =
