...
void lv_draw_dave2d_init(void)
{
    ...
    /* default: ON */
    lv_subject_init_int(&dave2d_enable, 1);
...
static int32_t _dave2d_evaluate(lv_draw_unit_t * u, lv_draw_task_t * t)
{
    ...
    if(lv_subject_get_int(&dave2d_enable) == 0) return 0;
...
static d2_s32 lv_dave2d_init(void)
{
    ...
    result = d2_setalphablendmode(_d2_handle, d2_bm_one, d2_bm_one_minus_alpha);
