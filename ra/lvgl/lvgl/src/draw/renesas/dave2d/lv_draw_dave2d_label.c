                                          ...
                                          lv_draw_fill_dsc_t * fill_draw_dsc, const lv_area_t * fill_area)
{
    if(glyph_draw_dsc) {
        ...
        /* d2_selectrenderbuffer(unit->d2_handle, unit->renderbuffer); */   /* The fill_area is rendered in the global buffer
                                                                             * instead of the label buffer. For example, the   
                                                                             * text may be completely covered by the background   
                                                                             * color when it should be readable on top of it.
                                                                             */
